export const projects = [
  {
    ...
    tags: ['Firebase', 'React', 'Messenger'],
    source: 'https://messenger-app-rsl.herokuapp.com',
    visit: 'https://messenger-app-rsl.herokuapp.com',
  ...
  },
  {
    ...
    source: 'https://arcane-peak-55315.herokuapp.com/',
    visit: 'https://arcane-peak-55315.herokuapp.com/',
  ...
  },
  {
    title: 'MadLibz',
    description:
      'This is a whimsical web application which allows a user create their own MadLibz story by entering a set of words or generated randomly based on part of speech! This is a JavaScript app incorporating two third-party word APIs.',
    image: '/images/madlibz.png',
    tags: ['JavaScript', 'HTML', 'CSS', 'Bulma'],
    source: 'https://teammadlibz.github.io/MadLibz/',
    visit: 'https://teammadlibz.github.io/MadLibz/',
  ...
  },
  {
    title: 'Eatdaburger',
    description:
      'A fun burger ordering app! The user can order any burger they like. The burger will be saved in their burger queue and moved to the devoured side when the user clicks eat-da-burger! This is a Heroku app build with node.js.',
    image: '/images/eatdaburger.png',
    tags: ['Handlebars', 'MySQL', 'Node.Js', 'Express.js', 'JavaScript'],
    source: 'https://burger-app-rluna.herokuapp.com/',
    visit: 'https://burger-app-rluna.herokuapp.com/',
  ...
  },
  {
    ...
    tags: ['Node.js'],
    source: 'https://www.youtube.com/watch?v=_9L0reNTwvs',
    visit: 'https://www.youtube.com/watch?v=_9L0reNTwvs',
  ...
  },
  {
    ...
    tags: ['Node.js'],
    source: 'https://budget-tracker-rluna.herokuapp.com/',
    visit: 'https://budget-tracker-rluna.herokuapp.com/',
